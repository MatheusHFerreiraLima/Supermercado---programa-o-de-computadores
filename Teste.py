...
texto = tk.Label(login, text="Fazer login")
...
botao = tk.Button(login, text="Login", command=clique)
...
def cadastro_itens():
    ...
    button_home = tk.Button(current_frame, text="Página Inicial", font=("Italic", 20), bg="lightskyblue", command=inicio)
...
def armazenar_dados():
    ...
    with open("produtos.txt", "a") as file:
        file.write(f"Código de Barras: {codigo_barras}, Nome do Produto: {nome_produto}, Valor do Produto: {valor_produto}\n")
    ...
    with open("produtos.txt", "r") as arquivo:
        for line in arquivo:
            if f"Código de Barras: {codigo_barras}" in line:
                ...
                tk.messagebox.showinfo("Erro", "digite algo")
